...
(async () => {
  ...
  const empresas_bahia = await csvService.convertCsvToJson("assets/empresas_bahia_lista_3.csv");

  const cidades = builderCidades(cidade_siafi, cidade_populacao)
